 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     @if (auth()->user()->role == 'admin')
        ...
        <li class="nav-item {{ Request::path() === 'payment' ? 'active' : '' }}">
     ...
     @elseif (Auth()->user()->role == 'supplier')
         ...
         <li class="nav-item {{ Request::path() === 'Thing' ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.thing') }}">
                <i class="fas fa-solid fa-cube"></i>
        ...
        <li class="nav-item {{ Request::path() === 'Pemesanan' ? 'active' : '' }}">
         ...
         <li class="nav-item {{ Request::path() === 'piutang' ? 'active' : '' }}">
             <a class="nav-link" href="{{ route('receivable.index') }}">
                 <i class="fas fa-solid fa-users"></i>
