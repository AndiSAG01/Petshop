    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('receivable.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-row mb-2">
                        <div class="col">
                            <label for="code">Nama Pelanggan</label>
...
<?php /**PATH C:\laragon\www\Petshop\resources\views/admin/piutang/tambah.blade.php ENDPATH**/ ?>