...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container-fluid">
        ...
        <?php endif; ?>
        <?php echo $__env->make('admin.sp.tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex" style="gap: 5px">
                                    <a href="/sp/<?php echo e($sp->id); ?>/edit" class="btn btn-warning"><i
                                            class="fa fa-gavel" aria-hidden="true"></i> Ubah</a>
                                    <form action="/sp/<?php echo e($sp->id); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?> 
<?php /**PATH C:\laragon\www\Petshop\resources\views/admin/sp/index.blade.php ENDPATH**/ ?>