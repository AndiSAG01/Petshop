    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5" style="background: rgb(255, 127, 236)">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image" style=" background-image: url('<?php echo e(asset('/adminassets/assets/images/kucing.jpg')); ?>');"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
...
<?php /**PATH C:\laragon\www\Petshop\resources\views/auth/register.blade.php ENDPATH**/ ?>