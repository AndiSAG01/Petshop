...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card shadow m-4">
        ...
        <div class="card-header bg-white mb-3">
            <form action="<?php echo e(route('admin.supplier.update', ['id' => $supplier->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-row">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" disabled value="<?php echo e($supplier->name_item); ?>">
                    </div>
                    <div class="form-group col-md-6">
...
<?php endif; ?> 
<?php /**PATH C:\laragon\www\Petshop\resources\views/admin/suppliers/edit.blade.php ENDPATH**/ ?>