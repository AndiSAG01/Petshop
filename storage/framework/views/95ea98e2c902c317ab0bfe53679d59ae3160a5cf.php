...
<head>
    ...
    <title><?php echo e($title); ?> | <?php echo e(App\Alamat_toko::first()->name_store); ?></title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter"><?php echo e($alert->count()); ?></span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <?php
                                    ...
                                    ->get();
                                    ?>
                                <?php $__currentLoopData = $order_terbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="dropdown-item d-flex align-items-center"
                                href="<?php echo e(route('admin.transaksi.detail', ['id' => $order->id])); ?>">
                                <div class="mr-3">
                                ...
                                <div>
                                    <div class="small text-gray-500 text-uppercase" sty><?php echo e($order->invoice); ?> -
                                        <?php echo e($order->nama_pemesan); ?> - <?php echo e($order->name); ?></div>
                                        <span class="font-weight-bold">Rp.
                                            <?php echo e(number_format($order->subtotal + $order->ongkir, 2, ',', '.')); ?></span>
                                        </div>
                                    </a>
...
<?php /**PATH C:\laragon\www\Petshop\resources\views/components/apps.blade.php ENDPATH**/ ?>